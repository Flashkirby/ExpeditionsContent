...
namespace ExpeditionsContent.Quests.Clerk
{
    class AlbumOmnibus1 : ModExpedition
    {
        ...
        {
            expedition.name = "Snap! The Omnibus";
        ...
        {
            return "You have photos of quite a few creatures now, perhaps you should compile them together? I can help you finish off a first edition, but you'll need to add a few things first. ";
        }
        #region Photo Bools
